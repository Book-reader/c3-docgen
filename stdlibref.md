...
```
```c3
struct CharType : ushort @private
```
### `std::core::bitorder`
```c3
struct ShortBE : short @bigendian
```
```c3
struct UShortBE : ushort @bigendian
```
```c3
struct IntBE : int @bigendian
```
```c3
struct UIntBE : int @bigendian
```
```c3
struct LongBE : long @bigendian
```
```c3
struct ULongBE : ulong @bigendian
```
```c3
struct Int128BE : int128 @bigendian
```
```c3
struct UInt128BE : uint128 @bigendian
```
```c3
struct ShortLE : short @littleendian
```
```c3
struct UShortLE : ushort @littleendian
```
```c3
struct IntLE : int @littleendian
```
```c3
struct UIntLE : int @littleendian
```
```c3
struct LongLE : long @littleendian
```
```c3
struct ULongLE : ulong @littleendian
```
```c3
struct Int128LE : int128 @littleendian
```
```c3
struct UInt128LE : uint128 @littleendian
```
```c3
...
```
### `std::core::machoruntime @if(env::DARWIN) @private`
```c3
...
```
```c3
fn void _dyld_register_func_for_add_image(DyldCallback)
```
```c3
fn void printf(char*, ...)
```
...
```
### `std::core::sanitizer::tsan @if(env::THREAD_SANITIZER) @private`
```c3
fn void __tsan_mutex_create(void* addr, CUInt flags)
```
...
```
```c3
macro Projection Projection.@add(&s, Projection #p) @operator(+)
```
```c3
...
```
```c3
macro F25519Int F25519Int.@add(&s, F25519Int #n) @operator(+)
```
```c3
fn F25519Int F25519Int.add(&s, F25519Int* n) @operator(+)
```
```c3
macro F25519Int F25519Int.@sub(&s, F25519Int #n) @operator(-)
```
```c3
...
```
```c3
macro F25519Int F25519Int.@mul(&s, F25519Int #n) @operator(*)
```
```c3
...
```
```c3
macro FBaseInt FBaseInt.@add(&s, FBaseInt #n) @operator(+)
```
```c3
...
```
```c3
macro FBaseInt FBaseInt.@mul(&s, FBaseInt #n) @operator(*)
```
```c3
